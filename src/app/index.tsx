...
export default function App() {
  ...
  // Carrega o login se a opção "Lembrar meu login" estava ativa
  ...
  // Função auxiliar para capturar o ID único do dispositivo
  ...
  async function fazerLogin() {
    ...
    try {
      ...
      // Persistência da preferência "Lembrar meu login"
  ...
  function handleBiometria() {

    Alert.alert("Biometria", "Funcionalidade de biometria em desenvolvimento.");
  ...
  function handleEsqueciSenha() {
    ...
    Alert.alert("Recuperar Senha", "Entre em contato com o administrador do sistema.");
        ...
        <View style={styles.background}>
          ...
          <View style={styles.card}>
            ...
            <View style={styles.form}>
              ...
              {/* Opções (Lembrar login / Esqueci senha) */}
            ...
            <TouchableOpacity style={styles.buttonBiometry} onPress={handleBiometria} activeOpacity={0.7}>

                <Ionicons name="finger-print-outline" size={22} color="#0052FF" style={{ marginRight: 10 }} />

                <Text style={styles.buttonBiometryText}>Entrar com biometria</Text>
